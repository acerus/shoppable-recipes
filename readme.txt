...
Сразу после установки и активации плагина лента будет доступна по адресу: `http://example.com/feed/whisk-recipe-widgets`
...
Если у вас возникли какие-то вопросы или появились предложения, милости просим на наш [форум поддержки](https://wordpress.org/support/plugin/whisk-recipe-widgets/) или [официальную страницу](https://www.kobzarev.com/projects/mail-ru-pulse-feed/) плагина.

### 💙 Нравится плагин? ###

Если плагин был полезен, поставьте ему [5 звезд](https://wordpress.org/support/plugin/whisk-recipe-widgets/reviews/#new-post) и напишите пару приятных слов.

== Installation ==

1. Upload `whisk-recipe-widgets` folder to the `/wp-content/plugins/` directory.
...
Сразу после установки плагина RSS лента будет доступна по адресу `http://example.com/feed/whisk-recipe-widgets`.
...
Присоединяйтесь к нам в [официальном GitHub репозитории](https://github.com/mihdan/whisk-recipe-widgets).
